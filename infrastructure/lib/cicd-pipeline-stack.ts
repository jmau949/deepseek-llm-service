          ...
          phases: {
            pre_build: {
              commands: [
                ...
                "# Verify ECR pull-through cache is working",
                "echo 'Testing ECR pull-through cache with a small image...'",
                "docker pull $AWS_ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/docker-hub/busybox:latest || echo 'WARNING: ECR pull-through cache test failed. Continuing anyway...'",
