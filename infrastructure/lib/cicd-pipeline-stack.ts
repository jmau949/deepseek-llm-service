          ...
          phases: {
            ...
            post_build: {
              commands: [
                ...
                "",
                "# Get the commit message for the release description",
                "commit = repo.get_commit(os.environ['CODEBUILD_RESOLVED_SOURCE_VERSION'])",
                ...
                "        tag=image_tag,",
                "        name=release_name,",
                "        message=f'Automatic release for commit {commit_hash}\\n\\nCommit message: {message}\\n\\nDocker image: {os.environ[\"ECR_REPOSITORY_URI\"]}:{image_tag}',",
                "        target_commitish=os.environ['CODEBUILD_RESOLVED_SOURCE_VERSION'],",
                "        draft=False,",
                "        prerelease=False",
                "    )",
                ...
                "    # Don't fail the build for release creation issues",
                '"',
                "  fi",
                "else",
